...
const Result = struct {
    ...
    pub fn append(self: *Result, elements: []u32) !void {
        try self.subset.append(self.allocator, elements);
    }

    pub fn append_items(self: *Result, elements: []const u32) !void {
...
pub fn main() !void {
    ...
    var nums = try allocator.alloc(u32, 3);
...
fn recurSubset(nums: *[]u32, ans: *Result, cur: *std.ArrayList(u32), index: usize, allocator: std.mem.Allocator) !void {
    ...
    try ans.append_items(cur.items);
    var i = index;
